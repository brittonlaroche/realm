...
public class TasksActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.fab).setOnClickListener(view -> {
            ...
            EditText itemPrice = dialogView.findViewById(R.id.price);
            EditText itemQuantity = dialogView.findViewById(R.id.quantity);
            new AlertDialog.Builder(TasksActivity.this)
                    .setTitle("Add a new item")
                    .setMessage("What is the item name, price and quantity for this store?")
                    .setView(dialogView)
            ...
            public void onSuccess(Realm realm) {
                ...
                if (project != null) {
                    ...
                    tasks.addChangeListener(list -> {
                        if (list.isEmpty()) {
                            setStatus("Press + to add a new Item");
                        } else {
                            setStatus("");
                        }
                    });
        ...
        ItemTouchHelper.SimpleCallback simpleItemTouchCallback = new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT) {
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, int swipeDir) {
                ...
                realm.executeTransactionAsync(realm -> {
                    Item item = realm.where(Item.class).equalTo("_id", id).findFirst();
                    if (item != null) {
